...
@section('section', lang('File', 'file password'))
@section('title', lang('Password', 'file password'))
@section('hide_title', true)
@section('header_version', 'v3')
@section('bg', 'only-nav')
@section('content')
    <section class="section-content mt-auto">
        <div class="container">
            <div class="locked text-center">
                <div class="col-12 col-sm-12 col-md-6 col-xl-4 mx-auto">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <div class="locked-img mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="866.52362"
                                    ...
                                    <rect x="279.40817" y="291.66149" width="191.03421" height="9.03209"
                                        fill="{{ $settings['website_primary_color'] }}" />
                                    <circle cx="263.87741" cy="250.53394" r="5.89453"
                                        fill="{{ $settings['website_primary_color'] }}" />
                                    ...
                                    <circle cx="515.67691" cy="438.20509" r="68.29339"
                                        fill="{{ $settings['website_primary_color'] }}" />
                                    <path
                            ...
                            <p class="h6 mb-3">{{ lang('Enter the password to unlock the file', 'file password') }}</p>
                            <form action="{{ route('file.password', $fileEntry->shared_id) }}" method="POST">
                                @csrf
                                <input type="hidden" name="_source" value="{{ request()->input('source') }}">
                                <div class="form-group input-password mb-3">
                                    <input type="password" name="password" class="form-control form-control-lg"
                                        placeholder="{{ lang('Enter password', 'file password') }}" required>
                                    <button type="button" class="text-muted"><i class="fa fa-eye"></i></button>
                                </div>
                                <button class="btn btn-primary w-100">{{ lang('Unlock', 'file password') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
