...
@section('content')
    ...
    <div class="card translate-card">
        <div class="card-header">
            <div class="mt-3 {{ count($groups) > 10 ? 'mb-3' : 'mb-4' }}">
            ...
            @endphp
            <ul class="nav
            {{ count($groups) > 10 ? 'nav-pills' : 'nav-tabs' }} card-header-tabs">
                ...
                @forelse($translates as $translate)
                    <div class="vironeer-translated-item d-block d-lg-flex bd-highlight align-items-center">
                        <div class="flex-grow-1 bd-highlight">
                            <textarea id="autosizeInput" class="vironeer-translate-key translate-fields form-control" rows="1" readonly>{{ $translate->key }}</textarea>
                        </div>
